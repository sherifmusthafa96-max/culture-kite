        ...
        <div className="min-h-screen bg-gray-50 px-6 py-16 relative">
            ...
            <div className="max-w-5xl mx-auto bg-white shadow-lg rounded-2xl p-8 relative overflow-hidden">
                ...
                <h1 className="text-4xl font-bold text-[#123A8D] mt-8">
                    ABT Parcel Services Careers
                </h1>

                {/* DESCRIPTION */}
                <p className="mt-4 text-gray-600 leading-relaxed">
                    ABT Parcel Services is one of South India's leading logistics
                    and parcel delivery companies. We are currently hiring
                    candidates for warehouse and logistics operations.
                </p>
                ...
                {/* APPLY BUTTON */}
                <Link
                    href="/apply?company=ABT&role=Warehouse Associate"
