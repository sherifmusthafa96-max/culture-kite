            ...
            <div className="max-w-5xl mx-auto bg-white shadow-lg rounded-2xl p-8 relative overflow-hidden">
                ...
                <div className="flex justify-center items-center">
                    <div className="h-24 w-24 bg-white rounded-2xl shadow-lg flex items-center justify-center">
                        <Image
                            src="/client-logos/shree-maruti.webp"
                            alt="ABT"
                            width={120}
                            height={60}
                ...
                <h1 className="text-4xl font-bold text-[#123A8D] mt-8 text-center">
                    Shree Maruti Careers
                </h1>

                {/* DESCRIPTION */}
                <p className="mt-4 text-gray-600 leading-relaxed text-center">
                    Shree Maruti Integrated Logistics Limited is one of India's
                    fastest-growing logistics and courier service providers.
                    We are hiring energetic candidates for warehouse and logistics operations.
                </p>
                ...
                <div className="grid md:grid-cols-3 gap-6 mt-10">
                    ...
                    <div className="bg-green-50 p-5 rounded-xl">
                        ...
                        <p className="text-sm text-gray-600 mt-2">
                            Weekly Off, Petrol Allowance, Incentives,
                ...
                {/* APPLY BUTTON */}
                <Link
                    href="/apply?company=Shree Maruti&role=Delivery Executive"
